<head>
       <title>Plastico - Admin Dashboard</title>
        <link rel="shortcut icon" href="../assets/login/images/img-01.png">
        <link rel="icon" type="image/png" href="assets/login/images/img-01.png"/>
